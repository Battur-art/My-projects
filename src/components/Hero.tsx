    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
        <div className="animate-fade-in">
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-racing font-black mb-6">
            <span className="heading-f1">SPEED</span>
            <span className="text-f1-white">.</span>
            <span className="heading-f1">PRECISION</span>
            <span className="text-f1-white">.</span>
            <span className="heading-f1">LEGACY</span>
          </h1>
