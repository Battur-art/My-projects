...
const DriverCard = ({ driver }: DriverCardProps) => {
  ...
  // Import the driver image dynamically using Vite's approach
  const getDriverImage = (photo: string) => {
    try {
      // Use new URL constructor with import.meta.url for Vite compatibility
    ...
    <>
      ...
      >
        <div className="relative mb-4 overflow-hidden rounded-lg">
          <img 
            src={getDriverImage(driver.photo)}
            alt={driver.name}
