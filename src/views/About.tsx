      ...
      <section className="bg-gradient-hero text-white py-20 bg-[url('/images/s25ultra.avif')] bg-cover bg-center">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
            Your trusted partner for the latest smartphones and mobile technology since 2005
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { name: 'Battur', role: 'CTO', bio: 'Former Apple engineer passionate about mobile innovation' },
