...
import { getFeaturedPhones, getBestSellers, getNewArrivals, phones } from '@/data/phones';
...
export default function HomePage() {
  ...
  const features = [
    { icon: Shield, title: 'Warranty Protection', description: 'All products come with manufacturer warranty' },
    { icon: Truck, title: 'Free Shipping', description: 'Free delivery on orders over ₮500' },
    { icon: CreditCard, title: 'Secure Payment', description: 'Your payment information is always secure' },
    { icon: Star, title: 'Premium Quality', description: 'Only authentic products from authorized dealers' },
  ];

  console.log(phones[0].originalPrice?.toLocaleString());
    ...
    <div className="min-h-screen">
        ...
        <FadeIn className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              ...
              <span className="block text-3xl md:text-5xl mt-2 opacity-90">Premium Technology</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/products">
                <Button variant="hero" size="xl" className='text-black'>
                  Shop Now
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <Stagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
      ...
      <section className="py-20 bg-gradient-primary text-white bg-[url('/images/amanz-fYru5LNyJiM-unsplash.jpg')] bg-cover bg-center">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Утсаа шинэчлэхэд бэлэн үү?</h2>
